...
--
-- Хост: 127.0.0.1
-- Час створення: Січ 03 2024 р., 15:22
...
--
-- AUTO_INCREMENT для таблиці `player`
--
ALTER TABLE `player`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT для таблиці `trainer`
--
ALTER TABLE `trainer`
...
--
-- Обмеження зовнішнього ключа таблиці `club`
--
ALTER TABLE `club`
...
--
-- Обмеження зовнішнього ключа таблиці `player`
--
ALTER TABLE `player`
